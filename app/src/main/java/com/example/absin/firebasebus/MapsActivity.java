...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    private static final int FASTEST_UPDATE_INTERVAL_MS = 50; // 0.5초
    ...
    LocationListener locationListener; // 정말 필요할까?
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView = (TextView) findViewById(R.id.searchMap_text);
        LinearLayout search = (LinearLayout) findViewById(R.id.searchMap_layout); //현 위치에서 주변정류장 검색

        String sitename = "클릭해서 주변정류장을 확인하기";
...
//        currentMarker = mGoogleMap.addMarker(markerOptions);
    ...
    public void setDefaultLocation() {
        ...
        //디폴트 위치, 경기대학교
        LatLng DEFAULT_LOCATION = new LatLng(37.3004892, 127.0336443);
    ...
    public void showPlaceInformation(LatLng location)
    {
        ...
        new NRPlaces.Builder()
                ...
                .key("AIzaSyAX8C01t6qdu8iNaQ7720Zgc0NbTjb505A")
                .latlng(location.latitude, location.longitude)//현재 위치
                .radius(4000) //넉넉하게 4km 다 걸려서 나온다
